...
enum SpellAttr1 : uint32
{
    ...
    /*NYI*/                                         // TITLE Prevents Anim DESCRIPTION Auras apply UNIT_FLAG_PREVENT_EMOTES_FROM_CHAT_TEXT
...
enum SpellAttr2 : uint32
{
    ...
    /*NYI, UNK*/                                                            // TITLE Always Cast As Unit
...
enum SpellAttr3 : uint32
{
    ...
    /*NYI, no damage history implementation*/          // TITLE No Damage History
    ...
    /*NYI*/                                           // TITLE Ignore Caster & Target Restrictions
...
enum SpellAttr5 : uint32
{
    ...
    /*NYI*/ // TITLE Ignore Target Requirements
    SPELL_ATTR5_NOT_ON_TRIVIAL = 0x00400000,
    /*NYI*/ // TITLE Not On Trivial
    SPELL_ATTR5_NO_PARTIAL_RESISTS = 0x00800000,
    /*NYI, resisting only some spell effects not implemented*/ // TITLE No Partial Resists
    SPELL_ATTR5_IGNORE_CASTER_REQUIREMENTS = 0x01000000,
    /*NYI*/                                              // TITLE Ignore Caster Requirements
...
enum SpellAttr6 : uint32
{
    ...
    /*NYI*/                                              // TITLE Allow On Charmed Targets
    ...
    /*NYI*/                               // TITLE AI Primary Ranged Attack
    SPELL_ATTR6_NO_PUSHBACK = 0x00008000, // TITLE No Pushback
    SPELL_ATTR6_NO_JUMP_PATHING = 0x00010000,
    /*NYI, currently jumps dont path at all*/                     // TITLE No Jump Pathing
    ...
    /*NYI, immunity to some buffs for some vehicles*/                         // TITLE Vehicle Immunity Category
    ...
    /*NYI*/                                            // TITLE Disable Tied Effect Points
...
enum SpellAttr7 : uint32
{
    ...
    /*NYI*/ // TITLE Prepare for Vehicle Control End
    SPELL_ATTR7_HORDE_SPECIFIC_SPELL = 0x00000100,
    /*NYI*/ // TITLE Horde Specific Spell
    SPELL_ATTR7_ALLIANCE_SPECIFIC_SPELL = 0x00000200,
    /*NYI*/                                          // TITLE Alliance Specific Spell
    ...
    /*NYI - deprecated attribute, there is no SPELL_GO sent anymore on pet resummon*/ // TITLE Recast On Resummon
    ...
    /*NYI, only used by 1 spell that is already filtered out in pvp credits because its self targeting*/ // TITLE Do Not Log PvP Kill
    ...
    /*NYI*/ // TITLE Retain Cooldown Through Load
    SPELL_ATTR7_IGNORES_COLD_WEATHER_FLYING_REQUIREMENT = 0x00400000,
    /*NYI - deprecated attribute*/                                  // TITLE Ignores Cold Weather Flying Requirement
...
enum SpellAttr8 : uint32
{
    ...
    SPELL_ATTR8_IGNORE_DYNAMIC_OBJECT_CASTER = 0x00000002,
    /*NYI*/                                                     // TITLE Ignore Dynamic Object Caster
    ...
    SPELL_ATTR8_ALLOW_WHILE_CHARMED = 0x00000020,
    /*NYI - not implementable currently, charming replaces AI*/ // TITLE Allow While Charmed
    SPELL_ATTR8_AURA_REQUIRED_BY_CLIENT = 0x00000040,
    /*NYI - we send all auras to client*/                               // TITLE Aura Required by Client
    ...
    SPELL_ATTR8_ALLOW_TARGETS_HIDDEN_BY_SPAWN_TRACKING = 0x00080000,
    /*NYI - no spawn tracking implementation*/            // TITLE Allow Targets Hidden by Spawn Tracking
    SPELL_ATTR8_REQUIRES_EQUIPPED_INV_TYPES = 0x00100000, // TITLE Requires Equipped Inv Types
    SPELL_ATTR8_NO_SUMMON_DEST_FROM_CLIENT_TARGETING_PATHING_REQUIREMENT = 0x00200000,
    /*NYI - vald path to a spell dest is not required currently if the dest comes from client*/ // TITLE No 'Summon + Dest from Client' Targeting Pathing Requirement
    ...
    SPELL_ATTR8_AI_FACE_TARGET = 0x08000000,
    /*NYI - unknown facing conditions, needs research*/                        // TITLE AI Face Target
...
enum SpellAttr9 : uint32
{
    ...
    SPELL_ATTR9_DO_NOT_ADD_TO_UNLEARN_LIST = 0x00000080,
    /* NYI - unlearn list not maintained SMSG_SEND_UNLEARN_SPELLS always empty */ // TITLE Do Not Add to Unlearn List
    ...
    SPELL_ATTR9_DONT_CONSUME_CHARGE_IF_ITEM_DELETED = 0x02000000,
    /*NYI - some sort of bugfix attribute to prevent double item deletion?*/ // TITLE (Programmer Only) Don't consume charge if item deleted
...
constexpr SkillType SkillByLockType(LockType locktype)
{
    ...
    case LOCKTYPE_ELUSIVE_HERBALISM:
        return SKILL_HERBALISM;
    case LOCKTYPE_MINING:
    case LOCKTYPE_MINING_2:
    case LOCKTYPE_ELUSIVE_MINING:
        return SKILL_MINING;
    ...
    case LOCKTYPE_SKINNING:
        return SKILL_SKINNING;
    case LOCKTYPE_CLASSIC_HERBALISM:
        return SKILL_CLASSIC_HERBALISM;
    ...
    case LOCKTYPE_LEGION_SKINNING:
        return SKILL_LEGION_SKINNING;
    case LOCKTYPE_SHADOWLANDS_HERBALISM:
        return SKILL_SHADOWLANDS_HERBALISM;
    case LOCKTYPE_SHADOWLANDS_MINING:
        return SKILL_SHADOWLANDS_MINING;
    case LOCKTYPE_COVENANT_NIGHT_FAE:
        return SKILL_COVENANT_NIGHT_FAE;
    case LOCKTYPE_COVENANT_VENTHYR:
        return SKILL_COVENANT_VENTHYR;
    case LOCKTYPE_COVENANT_KYRIAN:
        return SKILL_COVENANT_KYRIAN;
    case LOCKTYPE_COVENANT_NECROLORD:
        return SKILL_COVENANT_NECROLORD;
    case LOCKTYPE_ENGINEERING:
        return SKILL_ENGINEERING;
    case LOCKTYPE_DRAGON_ISLES_HERBALISM:
    case LOCKTYPE_DRAGON_ISLES_HERBALISM_25:
        return SKILL_DRAGON_ISLES_HERBALISM;
    case LOCKTYPE_ENCHANTING:
        return SKILL_ENCHANTING;
    case LOCKTYPE_DRAGON_ISLES_ALCHEMY_25:
        return SKILL_DRAGON_ISLES_ALCHEMY;
    case LOCKTYPE_DRAGON_ISLES_BLACKSMITHING_25:
        return SKILL_DRAGON_ISLES_BLACKSMITHING;
    case LOCKTYPE_DRAGON_ISLES_ENCHANTING_25:
        return SKILL_DRAGON_ISLES_ENCHANTING;
    case LOCKTYPE_DRAGON_ISLES_ENGINEERING_25:
        return SKILL_DRAGON_ISLES_ENGINEERING;
    case LOCKTYPE_DRAGON_ISLES_INSCRIPTION_25:
        return SKILL_DRAGON_ISLES_INSCRIPTION;
    case LOCKTYPE_DRAGON_ISLES_JEWELCRAFTING_25:
        return SKILL_DRAGON_ISLES_JEWELCRAFTING;
    case LOCKTYPE_DRAGON_ISLES_LEATHERWORKING_25:
        return SKILL_DRAGON_ISLES_LEATHERWORKING;
    case LOCKTYPE_DRAGON_ISLES_SKINNING_25:
        return SKILL_DRAGON_ISLES_SKINNING;
    case LOCKTYPE_DRAGON_ISLES_TAILORING_25:
        return SKILL_DRAGON_ISLES_TAILORING;
    case LOCKTYPE_DRAGON_ISLES_MINING:
    case LOCKTYPE_DRAGON_ISLES_MINING_25:
        return SKILL_DRAGON_ISLES_MINING;
    default:
        break;
    }
    return SKILL_NONE;
...
struct BattlegroundQueueTypeId
{
    ...
    {
        return uint64(BattlemasterListId) | (uint64(Type & 0xF) << 16) | (uint64(Rated ? 1 : 0) << 20) | (uint64(TeamSize & 0x3F) << 24) | UI64LIT(0x1F10000000000000);
    }
