...
public:
    ...
    ////处理打开/关闭对象
    // *使用HandleGameObject(0, boolen， GO)；在实例脚本中的OnObjectCreate
    // *使用HandleGameObject(GUID, boolean, nullptr)；在任何其他脚本中
    ...
    ////在gameobject-table中重生一个具有负刷出时间的GO
