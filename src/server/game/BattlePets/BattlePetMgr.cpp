...
namespace BattlePets
{
    ...
    void BattlePetMgr::LoadAvailablePetBreeds()
    {
        ...
        do
        {
            ...
            // 果需要，验证品种id（3 - 12（雄性）或3 - 22（雄性和雌性））
    ...
    void BattlePetMgr::SendJournal()
    {
        ...
        std::transform(_slots.begin(), _slots.end(), std::back_inserter(battlePetJournal.Slots), [](WorldPackets::BattlePet::BattlePetSlot &slot)
                       { return std::ref(slot); });
