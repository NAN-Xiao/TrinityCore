...
enum UnitState : uint32
{
    ...
    UNIT_STATE_ALL_STATE_SUPPORTED = UNIT_STATE_DIED | UNIT_STATE_MELEE_ATTACKING | UNIT_STATE_CHARMED | UNIT_STATE_STUNNED | UNIT_STATE_ROAMING | UNIT_STATE_CHASE | UNIT_STATE_FOCUSING | UNIT_STATE_FLEEING | UNIT_STATE_IN_FLIGHT | UNIT_STATE_FOLLOW | UNIT_STATE_ROOT | UNIT_STATE_CONFUSED | UNIT_STATE_DISTRACTED | UNIT_STATE_ATTACK_PLAYER | UNIT_STATE_CASTING | UNIT_STATE_POSSESSED | UNIT_STATE_CHARGING | UNIT_STATE_JUMPING | UNIT_STATE_MOVE | UNIT_STATE_ROTATING | UNIT_STATE_EVADE | UNIT_STATE_ROAMING_MOVE | UNIT_STATE_CONFUSED_MOVE | UNIT_STATE_FLEEING_MOVE | UNIT_STATE_CHASE_MOVE | UNIT_STATE_FOLLOW_MOVE | UNIT_STATE_IGNORE_PATHFINDING | UNIT_STATE_FOLLOW_FORMATION_MOVE,
...
{
public:
    explicit DispelInfo(WorldObject *dispeller, uint32 dispellerSpellId, uint8 chargesRemoved) : _dispeller(dispeller), _dispellerSpell(dispellerSpellId), _chargesRemoved(chargesRemoved) {}
...
public:
    ...
    void SetChannelSpellId(uint32 channelSpellId)
    {
        SetUpdateFieldValue(m_values
                                ...
                                .ModifyValue(&UF::UnitChannel::SpellID),
                            channelSpellId);
    }
    ...
    void SetChannelVisual(SpellCastVisual channelVisual)
    {
        SetUpdateFieldValue(m_values
                                .ModifyValue(&Unit::m_unitData)
                                .ModifyValue(&UF::UnitData::ChannelData)
                                .ModifyValue(&UF::UnitChannel::SpellVisual),
                            channelVisual);
    }
